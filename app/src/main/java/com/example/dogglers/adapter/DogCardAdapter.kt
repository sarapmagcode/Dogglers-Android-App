...
class DogCardAdapter(
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): DogCardViewHolder {
        var adapterLayout = if (layout == Layout.HORIZONTAL || layout == Layout.VERTICAL) {
    ...
    override fun onBindViewHolder(holder: DogCardViewHolder, position: Int) {
        ...
        holder.apply {
            ...
            dogAge?.text = resources?.getString(R.string.dog_age, dog.age)
            dogHobbies?.text = resources?.getString(R.string.dog_hobbies, dog.hobbies)
        }
    }
}
